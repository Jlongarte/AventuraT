...
public class CustomerController {
	...
	@DeleteMapping("/removeBooking/{tripId}")
	public ResponseEntity<ApiResponse<String>> removeBooking(@PathVariable String tripId) {

		String tripTitle = customerService.removeBooking(tripId);
