...
public class CustomerService implements ICustomerService {
	...
	@Override
	@Transactional(rollbackFor = Exception.class)
	public String removeBooking(String tripId) {
		...
		Booking booking = bookingRepository.findByCustomerAndTrip(customer, trip)
				.orElseThrow(() -> new BookingNotFoundException("Trip '" + trip.getTitle() + "' is not in your bookings"));
